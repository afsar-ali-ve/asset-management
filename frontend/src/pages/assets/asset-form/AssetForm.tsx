...
const AssetForm = ({ editing, mode, products, productTypes, vendors, assetStates, selectedProductTypeId, saving, onBack, onSave, }) => {
    const [formData, setFormData] = useState<any>(emptyAssetInput);
    const [workstationDetails, setWorkstationDetails] = useState<any>(emptyWorkstationDetails);
    const [workstationHardware, setWorkstationHardware] = useState<any>(createEmptyHardwareState);
